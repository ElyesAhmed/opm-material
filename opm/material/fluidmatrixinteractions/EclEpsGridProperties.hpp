...
public:
    ...
    const double * krwr(std::size_t active_index) const {
        return this->satfunc(this->compressed_krwr, map(active_index));
    }
    ...
    const double * krgr(std::size_t active_index) const {
        return this->satfunc(this->compressed_krgr, map(active_index));
    }
    ...
    const double * krorg(std::size_t active_index) const {
        return this->satfunc(this->compressed_krorg, map(active_index));
    }

    const double * krorw(std::size_t active_index) const {
        return this->satfunc(this->compressed_krorw, map(active_index));
    }
...
private:
    ...
    {
        return data.empty() ? nullptr : &data[map(active_index)];
    }
